...
assert.match(compactCss, /\.segmented\{[^}]*backdrop-filter:blur\(20px\) saturate\(140%\)/, "Segmented controls should use an iPhone-like glass container.");
...
assert.match(compactCss, /\.workspace-sidebar\{[^}]*border:0;box-shadow:none;backdrop-filter:blur\(20px\)/, "Sidebar glass should not have a frame or shadow.");
