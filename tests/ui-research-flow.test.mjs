...
assert.match(compactCss, /\.segmented\{[^}]*backdrop-filter:blur\(18px\) saturate\(135%\)/, "Segmented controls should use an iPhone-like glass container.");
...
assert.match(compactCss, /\.workspace-sidebar\{[^}]*border:0;box-shadow:none;backdrop-filter:blur\(18px\)/, "Sidebar glass should not have a frame or shadow.");
