...
assert.doesNotMatch(api, /generated_image_url|generatedImageUrl|imageStatus|"image URL"|properties\.image/, "V4 should remove image data from API and Notion records.");
