...
assert.match(api, /function limitGeneratedText\(value, maxLength = 220\)/, "Generated text should have a hard 220-character limit.");
assert.match(api, /generatedText = limitGeneratedText\(await createOpenAiText\(record\)\)/, "OpenAI output should be limited before Notion and browser responses.");
